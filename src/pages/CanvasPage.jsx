        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <HoverButton
              ...
              aria-pressed={canvasMode === "discuss"}
              className={`flex items-center gap-2 ${
                canvasMode === "discuss" ? "btn-default" : ""
              }`}
            >
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="rounded-xl border bg-white p-3 max-h-[120px] overflow-y-auto">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <button
                            ...
                            className="text-xs btn-default px-2 py-1 rounded"
                          >
                            New Chat
                          </button>
                        </div>
                    ...
                    <div className="h-[300px] rounded-xl border bg-slate-50/50 p-4 overflow-y-auto">
                      <div className="text-sm space-y-3">
                        ...
                        {/* Create Persona Form */}
                        {showCreatePersonaForm && (
                          <div className="p-4 bg-white rounded-lg shadow-sm border-2 border-purple-200">
                            <div className="mb-3">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      {chatMessages.length > 1 && (
                        <Button
                          variant="outline"
                          size="sm"
                          className="h-10 w-10 p-0 btn-default"
                      ...
                      <Button
                        ...
                        className={
                          ...
                          showPersonaSelection ||
                          showCreatePersonaForm
                            ? "h-10 w-10 p-0 bg-white border-black text-gray-500 cursor-not-allowed"
                            : "h-10 w-10 p-0 btn-default"
                        }
              ...
              <Card className="lg:col-span-1">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    {selectedVideo && (
                      <div className="mt-4 p-3 bg-btn-orange rounded-lg border border-black">
                    ...
                    <div className="mt-6">
                      <div className="flex items-center justify-between mb-2 gap-2">
                        ...
                        <Button
                          ...
                          className={
                            selectedVideo
                              ? "btn-default"
                              : "bg-white border-black text-gray-500 cursor-not-allowed"
                          }
                          size="sm"
                        >
                          {/* <Sparkles
                            className={`mr-1 h-3 w-3 ${selectedVideo ? "text-foreground" : "text-gray-400"}`}
                          /> */}
                          Start Analysis
                        </Button>
                      ...
                      <div
                        ...
                        className="h-[200px] rounded-xl border bg-slate-50/50 p-4 overflow-y-auto mb-3"
                      >
                            ...
                            <>
                              ...
                              {selectedVideo &&
                                ...
                                selectedVideo.aiAnalysis && (
                                  <div className="mb-4 p-3 bg-gray-100 rounded-lg border-l-8 border-blue-400">
                              ...
                              {selectedVideo && selectedVideo.transcript && (
                                <div className="mb-4 p-3 bg-gray-100 rounded-lg border-l-8 border-green-400">
                                  <strong className="text-black">
                                    Transkrip:
                                  </strong>
                                  <p className="text-black text-xs mt-1">
                          ...
                          {videoChatMessages.map((message) => (
                            <div
                              ...
                              className={`mb-3 p-3 rounded-lg ${
                                message.sender === "user"
                                  ? "bg-gray-100 border-l-6 border-gray-300 ml-8"
                      ...
                      <div className="flex gap-2 items-center">
                        ...
                        <Button
                          ...
                          className={
                            ...
                            !selectedVideo.hasAIAnalysis ||
                            isVideoChatLoading
                              ? "h-10 w-10 p-0 bg-white border-black text-gray-400 cursor-not-allowed"
                              : "h-10 w-10 p-0 btn-default"
                          }
                          disabled={
                            !selectedVideo ||
                  ...
                  <CardContent>
                    <div className="min-h-[300px] w-full rounded-xl border p-6 bg-slate-50/50">
                      ...
                      selectedVideo.aiSuggestions ? (
                          ...
                          {selectedVideo.aiSuggestions?.captionFix && (
                            <div className="bg-white rounded-lg p-4 border">
                              ...
                              <div className="space-y-2 text-sm">
                                ...
                                {selectedVideo.transcript && (
                                  <div className="mt-3 p-3 bg-btn-orange rounded border-l-6 border-orange-400">
                                    <span className="text-black font-medium text-xs">
                                      Transkrip Video:
                                    </span>
                                    <p className="text-black text-xs mt-1 max-h-20 overflow-y-auto leading-relaxed">
                                      "{selectedVideo.transcript}"
                                    </p>
                                  </div>
                                )}
                              ...
                              <div className="flex flex-wrap gap-2">
                                {selectedVideo.aiSuggestions.tagsFix.suggested.map(
                                  (tag, index) => (
                                    <span
                                      key={index}
                                      className="px-2 py-1 bg-white text-black border border:black text-xs rounded-full"
                                    >
                                      {tag}
                                    </span>
                                  )
                        ...
                        <div className="text-center space-y-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-500 max-w-md">
                              Video sudah memiliki transkrip, tapi belum
                              dianalisis oleh AI. Klik "Start Analysis" untuk
                        ...
                        <div className="text-center space-y-3">
                          <div className="w-16 h-16 mx-auto bg-btn-purple rounded-full flex items-center justify-center">
                            <Sparkles className="h-8 w-8 text-black font-normal" />
                          </div>
                          <div className="text-center">
                            ...
                            <p className="text-sm text-slate-500 text-center">
                              Klik "Start Analysis" untuk menganalisis video "
                              {selectedVideo.title || "Tanpa judul"}" dan
                              mendapatkan saran perbaikan dari AI.
                            </p>
                          </div>
                        </div>
                      ) : (
