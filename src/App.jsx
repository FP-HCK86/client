...
import LoginPageVisualClean from "./pages/LoginPageVisualClean";
...
function App() {
  return (
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          <Route path="/login" element={<LoginPageVisualClean />} />
          <Route path="/login-visual" element={<LoginPageVisual />} />
